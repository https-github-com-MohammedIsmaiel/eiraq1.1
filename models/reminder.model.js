...
module.exports = function(){
    ...
    cron.schedule('0 * * * *', () => {
        ...
        today = yyyy + '-' + mm+ '-' + dd;
        let query='SELECT events.*, accounts.email,accounts.username FROM events INNER JOIN  accounts ON owner_id= accounts.id WHERE CAST(start_date AS DATE) =$1 AND EXTRACT(HOUR FROM start_date) =$2'
