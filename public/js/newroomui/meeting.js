...
function blackmoon() {
	if (enabled) {
		document.querySelector("link[href='/css/newroomui/lightprofile.css']").href =
			'/css/newroomui/blackprofile.css';
		enabled = !enabled;
	} else {
		document.querySelector("link[href='/css/newroomui/blackprofile.css']").href =
			'/css/newroomui/lightprofile.css';
		enabled = !enabled;
	}
}
