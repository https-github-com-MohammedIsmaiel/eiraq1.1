			...
			reader.onload = function (e) {
				if (extension == 'pdf') {
					...
					$(input)
						...
						.attr(
							'src',
							'https://www.flaticon.com/svg/vstatic/svg/202/202311.svg?token=exp=1619877715~hmac=9e9d886d16826797afd9fc1f1dae455f',
						);
					...
					$(input)
						...
						.attr(
							'src',
							' https://www.flaticon.com/svg/vstatic/svg/2306/2306214.svg?token=exp=1619878277~hmac=878e351caa52333921da51737fd42c0a',
						);
				} else {
